...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-12 max-w-[50rem] text-center sm:mb-10 scroll-mt-[100rem]"
    >
      ...
      <motion.h1
        className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl text-gray-900 dark:text-gray-300"
      ...
      >
        ...
        <a
          className="flex items-center gap-2 py-3 transition bg-white rounded-full outline-none cursor-pointer group px-7 focus:scale-110 hover:scale-110 active:scale-105 borderBlack dark:bg-white/10 dark:text-white/80"
          href="/CV.pdf"
          download
          title="Download CV"
        >
